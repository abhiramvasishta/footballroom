...
async function backup() {
  console.log("Backing up 'matches' collection...");
  ...
  const backupPath = '../matches_backup.json';
  fs.writeFileSync(backupPath, JSON.stringify(matches, null, 2));
  console.log(`Backup saved to ${backupPath} (${Object.keys(matches).length} matches)`);
}
